...
This is a list of Mastodon/GNU Social instances blocked by [dizl.de](https://dizl.de). If you think an
instance has been unfairly blocked, please contact the administrators [nottulner](https://dizl.de/@nottulner).
...
-----
This overview is based on https://github.com/chaossocial/about/blob/master/blocked_instances.md and adapted for dizl.de
